...
export const WorkoutsWrapper = ({ workouts }: Props) => {
	...
	return (
		<ScrollArea className='h-[calc(100vh-160px)] mt-4 -mx-3 px-3 relative'>
			<div className='relative flex flex-col py-4 pl-1 gap-y-4'>
						...
						<div className='flex items-center justify-between ml-3'>
							<p
								className={cn(
									...
									isToday(new Date(date)) && 'text-primary'
								)}
							>
